...
to derive the world seed from [features](https://minecraft.wiki/w/Feature), [structures](https://minecraft.wiki/w/Structure)
or [surface rules](https://minecraft.wiki/w/Surface_rule).
